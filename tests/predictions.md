...
### P1: Position 518 is standard chess (RNBQKBNR) — ✅ PASS
...
### P2: Position 0 produces a specific arrangement — ✅ PASS
...
### P3: All 960 positions have bishops on opposite-colored squares — ✅ PASS
...
### P4: King is always between the two rooks — ✅ PASS
...
### P5: Exactly 960 unique positions exist — ✅ PASS
...
### P10: Database initializes successfully with all tables — ✅ PASS
...
### P11: Default config values are seeded — ✅ PASS
...
### P12: `createGame` randomly assigns king_color — ✅ PASS
...
### P13: `addSatsToPlayer` updates both balance and total earned — ✅ PASS
...
### P14: `resetEventData` preserves player accounts — ✅ PASS
...
### P20: `deductSatsFromPlayer` reduces balance and increases claimed — ✅ PASS
...
### P27: `buildFEN` uses the same piece arrangement for both sides — ✅ PASS
...
### P28: Auto-save interval is 30 seconds — ✅ PASS
